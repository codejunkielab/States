...
/// <summary>
/// Fake states context — provided for your testing convenience.
/// </summary>
public interface IFakeContext : IContext {
  /// <summary>Inputs added to the states.</summary>
  IEnumerable<object> Inputs { get; }

  /// <summary>Outputs added to the states.</summary>
  IEnumerable<object> Outputs { get; }

  /// <summary>Errors added to the states.</summary>
  IEnumerable<Exception> Errors { get; }

  /// <summary>
  /// Sets a fake value in the states's blackboard.
  /// </summary>
...
/// <summary>Fake states context used when testing StateCharts.</summary>
