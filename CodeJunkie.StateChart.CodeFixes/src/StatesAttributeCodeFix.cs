namespace CodeJunkie.StateChart.CodeFixes;
...
using CodeJunkie.StateChart.CodeFixes.Utils;
...
[Shared, ExportCodeFixProvider(
  LanguageNames.CSharp, Name = nameof(StateChartAttributeCodeFixProvider)
)]
public class StateChartAttributeCodeFixProvider : CodeFixProvider {
  public sealed override ImmutableArray<string> FixableDiagnosticIds {
    get;
  } = ImmutableArray.Create(
    Diagnostics.MissingStateChartAttributeDescriptor.Id
  );
  ...
  public sealed override async Task RegisterCodeFixesAsync(CodeFixContext context) {
    ...
    context.RegisterCodeFix(
      CodeAction.Create(
        title: "Add [StateChart] attribute",
        createChangedDocument: c => AddStateChartAttribute(
          context.Document,
          classDeclaration,
          c
        ),
  ...
  private async Task<Document> AddStateChartAttribute(
    Document document,
    ...
    var attribute = SyntaxFactory.Attribute(
      SyntaxFactory.ParseName("StateChart")
    ).WithArgumentList(
