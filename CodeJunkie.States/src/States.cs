...
/// <summary>
/// <para>
/// A states. Logic blocks are machines that receive input, maintain a
...
public interface ILogicBlock<TState> : ILogicBlockBase, ISerializableBlackboard where TState : StateLogic<TState> {
#else
public interface ILogicBlock<TState> : ILogicBlockBase, IBlackboard where TState : StateLogic<TState> {
#endif
  /// <summary>
...
/// <summary>
/// <para>
/// A synchronous states. Logic blocks are machines that process inputs
...
ILogicBlock<TState>, IBoxlessValueHandler where TState : StateLogic<TState> {
  ...
  // a states, such as when restoring from a saved / serialized logic
  // block.
...
#region ISerializableBlackboard
  ...
  /// <summary>
  /// Determines if two statess are equivalent. Logic blocks are equivalent
